...
public class Constant {
    public static final String BASE_LINK = "http://13.82.211.128:8080/administrator";
    public static final String USERNAME = "huy";
    public static final String PASSWORD = "huy123";
    public static final int TIME_OUT_SHORT = 10;
    public static final List<String> ARTICLE_CATEGORY = Arrays.asList("Sample Data-Articles", "A Darkling Plain");
    public static final List<String> CONTACT_CATEGORY = Arrays.asList("Sample Data-Contact", "- Park Site (en-GB)");
    public static final List<String> BANNERS_BANNERS_CATEGORY = Arrays.asList("Sample Data-Banners", "Uncategorised");


    //Status
    public static final String PUBLISHED = "Published";
    public static final String UNPUBLISHED = "Unpublished";
    public static final List<String> STATUS = Arrays.asList("Published", "Unpublished");
