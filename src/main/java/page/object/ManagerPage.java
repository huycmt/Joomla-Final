...
public class ManagerPage extends BasePage {
    ...
    private WebElement sortDrd(){return getDriver().findElement(_sortDrd);    }
    private WebElement sortBy(String by){return getDriver().findElement(By.xpath(String.format(_sortBy,by)));}
    private WebElement searchTool(){return getDriver().findElement(_searchTools);}
    private WebElement archiveBtn(){return getDriver().findElement(_archiveBtn);}

    private WebElement statusDrdInSearchTool1(){return getDriver().findElement(_statusDrdInSearchTool1);}
    private WebElement statusItemInSearchTool1(String status){return getDriver().findElement(By.xpath(String.format(_statusItemInSearchTool1,status)));}

    private WebElement statusDrdInSearchTool2(){return getDriver().findElement(_statusDrdInSearchTool2);}
    private WebElement statusItemInSearchTool2(String status){return getDriver().findElement(By.xpath(String.format(_statusItemInSearchTool2,status)));}

    private WebElement filterCategoryDrd(){return getDriver().findElement(_filterCategoryDrd);}
    private WebElement filterCategoryItem(String category){return getDriver().findElement(By.xpath(String.format(_filterCategoryItem,category)));}
    ...
    public void clickStatusItemInSearchTool(String status){
        clickElement(statusDrdInSearchTool1());
        clickElement(statusItemInSearchTool1(status));
    }
    public void clickStatusItemInSearchTool2(String status){
        clickElement(statusDrdInSearchTool2());
        clickElement(statusItemInSearchTool2(status));
    }

    public void clickCategoryItemInSearchTool(String category){
